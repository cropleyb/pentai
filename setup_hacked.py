...
# merge(base_flags, {'depends':'ai/foo.pxd'}),
    'ai/priority_filter_2.pyx': base_flags,
    'ai/priority_filter_3.pyx': base_flags,
    'ai/priority_filter_4.pyx': base_flags,
    'ai/priority_filter_5.pyx': base_flags,
    ...
    'ai/foo.pyx': base_flags, # merge(base_flags, {'depends':'ai/foo.pxd'}),
    }
