...
class SubStripCountingTest(unittest.TestCase):
    ...
    def test_black_right(self):
        ...
        self.assertEquals(self.threats, [0,1,0])

    def test_black_left(self):
        self.process_threats_for_str(" WWB   ", 1)
        self.assertEquals(self.threats,  [0,1,0])

    def test_white_right(self):
        self.process_threats_for_str("   WBB ", 4)
        self.assertEquals(self.threats, [0,0,1])

    def test_white_right_far(self):
        self.process_threats_for_str("   WBB ", 6)
        self.assertEquals(self.threats, [0,0,1])

    def test_white_left(self):
        self.process_threats_for_str(" BBW   ", 2) 
        self.assertEquals(self.threats, [0,0,1])

    def test_black_and_white(self):
        self.process_threats_for_str(" BBWW  ", 3)
        self.assertEquals(self.threats, [0,1,1])

    def test_two_threats(self):
        self.process_threats_for_str("WBB BBW", 3)
        self.assertEquals(self.threats, [0,0,2])

    def test_only_one_threat_affected(self):
        self.process_threats_for_str("WBB BBW", 6)
        self.assertEquals(self.threats, [0,0,1])

    # Some non-threat cases
    def test_black_bookended_no_threat(self):
        self.process_threats_for_str("  WBBW ", 3)
        self.assertEquals(self.threats, [0,0,0])

    def test_white_bookended_no_threat(self):
        self.process_threats_for_str("BWWB   ", 3)
        self.assertEquals(self.threats, [0,0,0])
    ...
    def test_capture_spot_would_be_off_right(self):
        self.process_threats_for_str("   WBB", 3)
        self.assertEquals(self.threats, [0,0,0])
    ...
    def test_zebra_above(self):
        self.process_threats_for_str("WBB WWB", 4)
        self.assertEquals(self.threats, [0,1,0])

    def test_gap(self):
        self.process_threats_for_str("  W BB ", 3)
        self.assertEquals(self.threats, [0,0,0])
