...
class TestGameDefaults(unittest.TestCase):
    ...
    def test_initial(self):
        ...
        pn1 = self.gd.get_player_name(BLACK)
        pn2 = self.gd.get_player_name(WHITE)
        pt1 = self.gd.get_type(BLACK)
        pt2 = self.gd.get_type(WHITE)
    ...
    def test_name_of_p2(self):
        ...
        self.gd.set_name(WHITE, "Deep Thunk")
    ...
    def test_set_names_and_toggle_type(self):
        ...
        self.gd.set_type(BLACK, "Human")
        self.gd.set_name(BLACK, "Bruce")
        self.gd.set_type(WHITE, "Human")

        pt1 = self.gd.get_type(BLACK)
        self.assertEquals(pt1, "Human")
        pn1 = self.gd.get_player_name(BLACK) # This is returning BC
